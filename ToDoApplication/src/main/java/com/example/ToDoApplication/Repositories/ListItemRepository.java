...
public interface ListItemRepository extends JpaRepository<ListItem, Long> {
    ...
    void updateNextById(@Param("id") Long idOfListItemToChangeIn, @Param("next") Long newNext);
    @Modifying
    @Query("UPDATE ListItem l SET l.previous = :previous WHERE l.id = :id")
    void updatePreviousById(@Param("id") Long idOfListItemToChangeIn, @Param("previous") Long newPrevious);
